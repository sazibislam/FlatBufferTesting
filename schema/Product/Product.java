...
public final class Product extends Table {
  ...
  public String amount() { int o = __offset(4); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer amountAsByteBuffer() { return __vector_as_bytebuffer(4, 1); }
  public long id() { int o = __offset(6); return o != 0 ? bb.getLong(o + bb_pos) : 0L; }
  public String image() { int o = __offset(8); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer imageAsByteBuffer() { return __vector_as_bytebuffer(8, 1); }
  public String link() { int o = __offset(10); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer linkAsByteBuffer() { return __vector_as_bytebuffer(10, 1); }
  ...
  public static void startProduct(FlatBufferBuilder builder) { builder.startObject(6); }
  public static void addAmount(FlatBufferBuilder builder, int amountOffset) { builder.addOffset(0, amountOffset, 0); }
  ...
  public static void addLink(FlatBufferBuilder builder, int linkOffset) { builder.addOffset(3, linkOffset, 0); }
